        ...
        <section >
            <div className="container mx-auto">
                <div className='md:flex items-center my-[50px] md:my-[70px] lg:my-[90px]  gap-[40px]'>
                    <div className=' lg:w-7/12' data-aos="fade-left" data-aos-duration="800" data-aos-delay="300" data-aos-easing="linear">
                    ...
                    <div className='pb-[50px] md:pb-0  lg:w-5/12 md:order-first'data-aos="fade-right" data-aos-duration="800" data-aos-delay="300" data-aos-easing="linear">
