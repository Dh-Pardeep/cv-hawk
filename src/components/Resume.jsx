            ...
            <div className="container mx-auto">
                <div className='md:flex items-center my-[50px] md:my-[70px] lg:my-[90px]  gap-[40px]'>
                    <div className=' lg:w-7/12' data-aos="fade-left" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                        <h2 className='text-[#010101] font-Rubik text-[27px] md:text-[30px] pt-[40px] md:pt-0 pb-[15px] lg:max-w-[402px] relative  font-semibold'>Resume trailoring based on the<span className='text-[#F36A3E] relative'><img className='w-full hidden lg:block absolute left-0 -bottom-4' src={BuilderDownImg} alt="BuilderDownImg" /> job you’re applying</span> for</h2>
