        ...
        <section className='bg-[#F9F9F9] relative'>
            ...
            <div className="container mx-auto">
                <div className='md:flex items-center md:py-[80px] '>
                    <div className='md:w-6/12 ' data-aos="fade-right" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                        ...
                        <p className='text-black font-Rubik text-[13px] md:text-[16px] font-normal leading-[150%] pb-[30px] md:pb-0 lg:max-w-[455px] xl:max-w-none'>Express your professional history without limitations or worry about how your resume looks</p>
                        <div className='flex mb-[22px] mt-[24px]'>
                            <div className='me-[12px] mt-[3px]  cursor-pointer'>
                                <TrueIcon />
                            </div>
                            <p className='font-normal text-black font-Rubik text-[13px] md:text-[15px] lg:text-[16px] '>Professional sections like <span className='font-semibold'>Experience, Skills, Summary</span> and <span className='font-semibold'>Education</span></p>
                        </div>
                        <div className='flex mb-[22px]'>
                            <div className='me-[12px] mt-[3px] cursor-pointer'>
                                <TrueIcon />
                            </div>
                            <p className='font-normal text-black font-Rubik text-[13px] md:text-[15px] lg:text-[16px] '>Professional sections like <span className='font-semibold'>Strengths, Quotes, Books, Interests</span> and <span className='font-semibold'>My Time.</span></p>
                        </div>
                        <div className='flex'>
                            <div className='me-[12px] mt-[3px] cursor-pointer'>
                                <TrueIcon />
                            </div>
                            <p className='font-normal text-black font-Rubik text-[13px] md:text-[15px] lg:text-[16px] '>Professional sections like <span className='font-semibold'> Certifications, Awards, Achievements, Language</span> and <span className='font-semibold'>Reference</span></p>
                        </div>
                        <div className='flex'>
                    ...
                    <div>
                        <div className=' md:w-6/12  lg:w-6/12 relative ' data-aos="fade-left" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
