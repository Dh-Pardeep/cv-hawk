        ...
        <section className='bg-[#F9F9F9] '>
            <div className="container mx-auto">
                <div className='md:flex items-center md:py-[80px]'>
                    <div className=' lg:w-7/12'  data-aos="fade-right" data-aos-duration="800" data-aos-delay="300" data-aos-easing="linear">
                    ...
                    <div className='pb-[50px] md:pb-0  lg:w-5/12  ' data-aos="fade-left" data-aos-duration="800" data-aos-delay="300" data-aos-easing="linear">
