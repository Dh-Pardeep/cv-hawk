    ...
    return (
        <section className='bg-[#F9F9F9] '>
            <div className="container mx-auto relative">
                <h2 className="text-black font-semibold text-[28px] md:text-[30px] lg:text-[40px]  font-Rubik leading-none text-center pt-[40px] md:pt-[60px] lg:pt-[80px] pb-[30px] md:pb-[40px] lg:pb-[45px]" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">What our Clients Say</h2>
                <div className='relative md:hidden'data-aos="zoom-in" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                    <div onClick={() => slidertwo?.current?.slickPrev()}
                    ...
                    <div onClick={() => slidertwo?.current?.slickNext()}
                        ...
                        <svg className="w-[16px] h-[16px] md:w-[24px] md:h-[24px] transition-all duration-300  ease-in-out" width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.14131 20.9116L11.3477 11.4671C11.5094 11.3013 11.5999 11.0788 11.5999 10.8471C11.5999 10.6155 11.5094 10.393 11.3477 10.2271L2.14131 0.779108C2.06599 0.701748 1.97593 0.640263 1.87646 0.598278C1.77699 0.556293 1.67011 0.534666 1.56214 0.534666C1.45417 0.534666 1.34729 0.556293 1.24782 0.598278C1.14834 0.640263 1.05829 0.701748 0.982965 0.779108C0.827007 0.937754 0.741254 1.15072 0.741254 1.37249C0.741254 1.59426 0.827007 1.80723 0.982965 1.96588L9.64035 10.8471L0.982965 19.7266C0.828538 19.8851 0.742121 20.0977 0.742121 20.3191C0.742121 20.5404 0.828538 20.753 0.982965 20.9116C1.05829 20.9889 1.14834 21.0504 1.24782 21.0924C1.34729 21.1344 1.45417 21.156 1.56214 21.156C1.67011 21.156 1.77699 21.1344 1.87646 21.0924C1.97593 21.0504 2.06599 20.9889 2.14131 20.9116Z" fill="#F36A3E" />
                        </svg>
                    </div>
                    <Slider ref={slidertwo} {...settingsThree}>
                ...
                <div className='relative hidden md:block lg:hidden'data-aos="zoom-in" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                    <div onClick={() => sliderthree?.current?.slickPrev()}
                    ...
                    <div onClick={() => sliderthree?.current?.slickNext()}
                    ...
                    <Slider ref={sliderthree} {...settingsfour} className='pb-[50px]'>
                ...
                <div className='relative hidden lg:block 'data-aos="zoom-in" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
