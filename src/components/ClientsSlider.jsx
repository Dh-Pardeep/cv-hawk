    ...
    return (
        <section className='bg-[#F9F9F9] '>
            <div className="container mx-auto relative">
                <h2 className="text-black font-medium text-[28px] md:text-[30px] lg:text-[40px]  font-Rubik leading-none text-center pt-[40px] md:pt-[60px] lg:pt-[80px] pb-[30px] md:pb-[40px] lg:pb-[45px]" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">What our Clients Say</h2>
