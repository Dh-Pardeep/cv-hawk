    ...
    return (
        <section className='relative'>
            ...
            <div className="container mx-auto" data-aos="zoom-in" data-aos-duration="700" data-aos-delay="3000" data-aos-easing="linear">
                <h1 className='font-Rubik text-black text-center text-[32px] sm:text-[40px]  lg:text-[45px] xl:text-[52px] max-w-[766px] mx-auto pt-[130px] sm:pt-[160px] md:pt-[202px] lg:pt-[250px] font-semibold relative'><img className='absolute top-[37%] sm:top-[42%] sm:left-[18%] md:top-[46%] md:left-[23%] left-[22%] lg:top-[46%] w-[30px] h-[30px] sm:w-[42px] sm:h-[42px] md:w-[52px] md:h-[52px]  lg:w-[64px] lg:h-[64px]' src={UnlockUpper} alt="UnlockUpper" />Unlock Your Potential with a Professional <span className='whitespace-nowrap relative '><img className='w-full absolute left-0 -bottom-1' src={BuilderDownImg} alt="BuilderDownImg" /> CV Builder</span></h1>
