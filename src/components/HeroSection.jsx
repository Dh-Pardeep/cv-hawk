...
const HeroSection = () => {
    return (
        <section className='relative'>
            ...
            <MyNavBar />
            <div className="container mx-auto" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="3000" data-aos-easing="linear">
                ...
                <div className='flex  items-center  justify-center mt-[30px] md:mt-[40px]'>
                    <Link data-aos="fade-right" data-aos-duration="800" data-aos-delay="3000" data-aos-easing="linear" onClick={() => setShowNavbar(true)} className='px-[22px] py-[14px]  xs:px-[38px] xs:py-[17px] bg-[#F36A3E] text-white common_btn rounded-[41px]  font-semibold font-Rubik hover:text-white inline-block xs:me-[17px] ' to="/Touch">Get Started</Link>
                    <Link data-aos="fade-left" data-aos-duration="800" data-aos-delay="3000" data-aos-easing="linear" onClick={() => setShowNavbar(true)} className='px-[22px] py-[14px] xs:px-[38px] xs:py-[17px] bg-transparent text-[#F36A3E] ms-[11px] xs:ms-0 common_btn hover:bg-transparent rounded-[41px] font-semibold font-Rubik inline-block ' to="/Touch">Watch Demo</Link>
                </div>
            </div>
        </section>
    )
