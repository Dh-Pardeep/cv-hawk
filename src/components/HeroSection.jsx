...
const HeroSection = () => {
    return (
        <section className='relative'>
           ...
           <img className='absolute hidden md:block bottom-[-160px] xl:bottom-[-210px]  rotate-[-33deg]  w-[185px] left-4  lg:w-[207px] h-[200px] lg:h-[227px]  shadow-[0px_2.01812px_23.5447px_0px] xl:left-[145px] shadow-[#d3d0d0] rounded-[10px]' src={LeftImgtwo} alt="" /> 
           ...
           <img className='absolute hidden md:block bottom-[-160px] xl:bottom-[-210px]  rotate-[28deg]  w-[185px] right-4  lg:w-[207px] h-[200px] lg:h-[227px]  shadow-[0px_2.01812px_23.5447px_0px] xl:right-[145px] shadow-[#d3d0d0] rounded-[10px]' src={RightImgtwo} alt="" /> 
            {/* <img className='absolute hidden md:block right-0' src={RightImg} alt="" /> */}
            {/* <img className='absolute hidden md:block bottom-0  right-0' src={RightImgtwo} alt="" /> */}
            ...
            <div className='absolute rounded-[278px] md:rounded-[518] lg:rounded-[626px] opacity-[0.6] bg-[#F36A3E] blur-[75px] md:blur-[120px] w-[278px] md:w-[518px] lg:w-[626px] md:h-[95px] lg:h-[115px] h-[66px] top-[40%] md:top-[50%] start-[50%] translate-x-[-50%] translate-y-[-50%]' ></div>
            <MyNavBar />
            <div className="container mx-auto">
                ...
                <div className='flex  items-center  justify-center mt-[30px] md:mt-[40px]'>
                    <Link onClick={() => setShowNavbar(true)} className='px-[22px] py-[14px]  xs:px-[38px] xs:py-[17px] bg-[#F36A3E] text-white common_btn rounded-[41px]  font-semibold font-Rubik hover:text-white inline-block xs:me-[17px] ' to="/Touch">Get Started</Link>
                    <Link onClick={() => setShowNavbar(true)} className='px-[22px] py-[14px] xs:px-[38px] xs:py-[17px] bg-transparent text-[#F36A3E] ms-[11px] xs:ms-0 common_btn hover:bg-transparent rounded-[41px] font-semibold font-Rubik inline-block ' to="/Touch">Watch Demo</Link>
                </div>
            </div>
        </section>
    )
