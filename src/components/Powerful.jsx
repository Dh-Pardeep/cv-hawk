            ...
            <div className="container mx-auto">
                <div className='md:flex items-center md:py-[80px]'>
                    <div className='md:w-7/12' data-aos="fade-right" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                        <h2 className='text-[#010101] font-Rubik text-[27px] md:text-[30px] font-medium pt-[40px] md:pt-0 pb-[15px] lg:max-w-[392px] relative'><img className=' absolute hidden md:block lg:hidden top-[-38px]  left-[28px]   md:w-[40px] md:h-[40px]  ' src={UnlockUpper} alt="UnlockUpper" />Powerful Tools to Create <span className='text-[#F36A3E]'><img className='w-[254px]  absolute hidden left-0 lg:block bottom-3' src={BuilderDownImg} alt="BuilderDownImg" />Your <span className='md:whitespace-nowrap relative'><img className='w-full lg:w-[120%] absolute hidden md:block left-0 lg:hidden -bottom-1' src={BuilderDownImg} alt="BuilderDownImg" />Standout CV</span></span></h2>
