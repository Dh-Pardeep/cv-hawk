        ...
        <section className='bg-[#F9F9F9] relative'>
            ...
            <div className="container mx-auto">
                <div className='md:flex items-center md:py-[80px]'>
                    ...
                    <div className='pb-[40px] md:pb-0 md:w-5/12 flex items-center justify-center'  data-aos="fade-left" data-aos-duration="800" data-aos-delay="300" data-aos-easing="linear">
