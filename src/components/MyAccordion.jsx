    ...
    return (
        <section className="relative">
            ...
            <div className="container mx-auto mb-[455px] md:mb-[290px]">
                <h2 className="text-black pt-[100px]  font-semibold text-[28px] md:text-[30px] lg:text-[40px]  font-Rubik leading-none text-center md:pt-[120px] lg:pt-[150px] pb-[20px] md:pb-[60px] "data-aos="fade-up" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">Frequently Asked Questions</h2>
                ...
                <div className="container relative" data-aos="zoom-in" data-aos-duration="700" data-aos-delay="300" data-aos-easing="linear">
                    <div className="rounded-[21px] bg-[#F36A3E] w-full px-[21px] py-[60px] md:py-[36px] lg:py-[64px] absolute left-0 top-[90px] sm:top-[145px] md:top-[50px]">
                        <h2 className="text-center font-Rubik text-[28px] md:text-[30px] lg:text-[40px] font-semibold text-white md:max-w-[669px] mx-auto">Your Path to Success Starts Here: Build Your CV Today</h2>
